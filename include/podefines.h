...
#define _POD_REFINED_               // If set, refines classification (consumes time)
...
#define _POD_GABOR_FNAME_   "config/GABOR.CSV"      // CSV file with Gabor data.
#define _POD_SVM_FNAME_     "data/TRAINDATA.XML"    // XML file to save/load trained SVM.
